   ...
   Ident.create(ident_code: "R9388392", name: 'Ident1', weight: 59.00, programiranje: 72.5,status: "new",color: project1.color,  project_id: project1.id, production_line_text: production_line1.description, estimated_hours: 2, priority: 5)
    Ident.create(ident_code: "Z8287286", name: 'Ident4', weight: 59.00, programiranje: 72.5,status: "new",color: project1.color, project_id: project1.id, production_line_text: production_line1.description, estimated_hours: 8, priority: 2)

   Ident.create(ident_code: "JSOU83", name: 'The damage ', weight: 59.00, programiranje: 72.5,status: "new",color: project2.color, project_id: project2.id, production_line_text: production_line1.description, estimated_hours: 9, priority: 3)
   Ident.create(ident_code: "J3992U", name: 'Its request grows.', weight: 59.00, programiranje: 72.5,status: "new",color: project2.color, project_id: project2.id, production_line_text: production_line1.description, estimated_hours: 9, priority: 3)
   Ident.create(ident_code: "R9388392", name: 'Ident1', weight: 59.00, programiranje: 72.5,status: "new",color: project1.color,  project_id: project1.id, production_line_text: production_line1.description, estimated_hours: 2, priority: 5)
    Ident.create(ident_code: "Z8287286", name: 'Ident4', weight: 59.00, programiranje: 72.5,status: "new",color: project1.color, project_id: project1.id, production_line_text: production_line1.description, estimated_hours: 8, priority: 2)
